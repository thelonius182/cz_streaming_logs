proc_gh_logs <- function(pe_log_type) {
  ...
  # load log history ----
  gh_rds_filename <- paste0("c:/Users/nipper/Documents/ghlogs/cz_streaming_logs/gh_logs_history/gh_logs_his",
  ...
  if (nrow(gh_logs_new) == 0) {
    ...
    gh_fs_dir <-
      paste0("C:/Users/nipper/Documents/ghlogs/cz_streaming_logs/",
